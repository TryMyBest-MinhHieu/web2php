   ...
   <section class="products">
      ...
      <div class="box-container">
         ...
         ?>
               <form action="" method="post" class="box">
                  ...
                  <div class="sub-total"> tổng cộng : <span>$<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
               </form>
         <?php
      ...
      <div class="more-btn">
         <form action="" method="post">
            <button type="submit" class="delete-btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>" name="delete_all" onclick="return confirm('Bạn muốn xoá toàn bộ?');">Xoá tất cả</button>
         </form>
