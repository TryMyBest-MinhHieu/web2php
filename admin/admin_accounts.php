...
<section class="accounts">
   ...
   <h1 class="heading">Quản trị tài khoản<nav></nav></h1>

   <div class="box-container">

   <div class="box">
      <p>Tạo mới người dùng quản trị   </p>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="update_profile.php?update=<?= $fetch_accounts['id']; ?>&name=<?= $fetch_accounts['name']; ?>&role=<?= $fetch_accounts['role_id']; ?>" class="option-btn">update</a>
